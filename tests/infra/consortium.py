...
class Consortium:
    ...
    def set_ca_cert_bundle(self, remote_node, cert_name, cert_pem_path, skip_checks=False):
        proposal_body, careful_vote = self.make_proposal(
    ...
    def remove_ca_cert_bundle(self, remote_node, cert_name):
        proposal_body, careful_vote = self.make_proposal("remove_ca_cert_bundle", cert_name)
        proposal = self.get_any_active_member().propose(remote_node, proposal_body)
        return self.vote_using_majority(remote_node, proposal, careful_vote)
