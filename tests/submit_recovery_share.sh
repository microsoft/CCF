...
resp=$(curl -X GET https://${node_rpc_address}/members/recovery_share ${@})
...
curl https://${node_rpc_address}/members/recovery_share/submit ${@} -H "Content-Type: application/json" -d '{"recovery_share": "'${decrypted_share}'"}'