...
with open("coverage.json", "r") as file:
    ...
    coverage = et.Element("coverage", attrib={"line-rate":line_rate,
        "lines-covered":lines_covered, "lines-valid":lines_valid,
        "branches-covered":branch_covered, "branches-valid":branch_valid,
        "branch-rate":branch_rate, "version":"1.0", "timestamp":"0000001"})
    ...
    for file in files:
        ...
        et.SubElement(classes, "class", name=filename, attrib={"filename": filename,
            "line-rate":line_rate, "lines-covered": lines_covered, "lines-valid": lines_valid,
            "branch-rate": branch_rate, "branches-covered": branch_covered, "branches-valid": branch_valid})
