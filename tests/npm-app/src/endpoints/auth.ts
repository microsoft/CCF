...
function describe_user_cert_ident(lines: Lines, obj: ccfapp.UserCertAuthnIdentity) {
...
function describe_member_cert_ident(lines: Lines, obj: ccfapp.MemberCertAuthnIdentity) {
...
function describe_user_cose_ident(lines: Lines, obj: ccfapp.UserCOSESign1AuthnIdentity) {
...
function describe_member_cose_ident(lines: Lines, obj: ccfapp.MemberCOSESign1AuthnIdentity) {
...
function describe_allofauth_ident(lines: Lines, obj: ccfapp.AllOfAuthnIdentity) {
