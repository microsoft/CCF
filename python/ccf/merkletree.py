...
class MerkleTree(object):
    ...
    def _calculate_next_level(self):
        ...
        if number_of_leaves_on_current_level % 2 == 1:  # if odd number of leaves on the level
        ...
        new_level = []
        for left_node, right_node in zip(self.levels[0][0:number_of_leaves_on_current_level:2], self.levels[0][1:number_of_leaves_on_current_level:2]):
