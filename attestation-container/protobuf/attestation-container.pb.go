...
type FetchAttestationReply struct {
	...
	UvmEndorsement                     string `protobuf:"bytes,3,opt,name=uvm_endorsement,json=uvmEndorsement,proto3" json:"uvm_endorsement,omitempty"`
}
...
func (x *FetchAttestationReply) GetUvmEndorsement() string {
	if x != nil {
...
var file_protobuf_attestation_container_proto_rawDesc = []byte{
	...
	0x6e, 0x64, 0x6f, 0x72, 0x73, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09,
