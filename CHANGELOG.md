...
[5.0.15]: https://github.com/microsoft/CCF/releases/tag/5.0.15
...
- Normalise private recovery triggers by unifying to a single on-hook approach on `network.secrets`. Comes as prerequisite to #6926 (#6912).
