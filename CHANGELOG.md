...
- Joining nodes can verify downloaded COSE snapshots signed by a previous service identity using an endorsement chain rooted in the configured current service identity (#8361).
