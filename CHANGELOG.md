...
- Pending node entries are now automatically removed after the configurable `pending_node_timeout` delay (24 hours by default). Set it to `0s` to disable automatic removal (#8173).
