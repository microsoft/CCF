...
- Added `ccf::EndorsementsNotFetchedError` exception type to distinguish endorsement-fetching errors from other logic errors in the network identity subsystem.
