...
- Clang builds now enable compile-time thread safety analysis for the annotated `ccf::pal::Mutex`, with reusable annotations available from `ccf/ds/thread_safety.h` (#8180).
