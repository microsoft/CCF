...
- `add_ccf_app()` accepts `OBJECT` to share compiled application sources between executables. The sample applications now reuse their common entry point and logging implementation instead of compiling them for each binary (#8362).
