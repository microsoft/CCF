...
- 5.0.0 is the last long term support release for Intel SGX. Live code upgrades to Confidential Containers and Confidential AKS (AMD SEV-SNP) are supported.
- Request forwarding between nodes is deprecated in favour of HTTP redirects, and will be removed in 6.0.0.
- Recovery shares created with CCF < 4.0.9 are deprecated, and support will be removed in 6.0.0. Ledgers created on older versions must re-share at least once after having upgraded to a post 4.0.9 release.
