...
def mainGuarantees : Array Name := #[
  ...
  ``Kv.step_capture_paired,
  ``Kv.step_capture_cut_values,
  ``Kv.capture_replay_preserves_pair,
  ``Kv.replay_snapshot_fixed,
  ``Kv.reachable_snapshot_global_safety,
  ``Kv.step_global_read_from_irrevocable_prefix,
  ``Kv.step_global_has_from_irrevocable_prefix,
