...
#pragma pack(pop)
  ...
  using GuestRequestAttestation = GuestRequest<AttestationReq, AttestationResp>;
  using GuestRequestDerivedKey = GuestRequest<DerivedKeyReq, DerivedKeyResp>;
