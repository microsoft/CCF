...
namespace ccf::pal::snp
{
  ...
  struct EndorsementEndpointsConfiguration
  {
    struct EndpointInfo
    {
      ...
      size_t max_response_size = SIZE_MAX;
  ...
  struct EndorsementsServer
  {
    ...
    std::optional<ccf::ds::SizeString> max_response_size = std::nullopt;
  ...
  DECLARE_JSON_OPTIONAL_FIELDS(
    EndorsementsServer, type, url, max_retries_count, max_response_size);
  ...
  )
  {
    ...
    leaf.max_response_size = max_response_size;
    ...
    chain.max_response_size = max_response_size;
