...
public:
  ...
  // Requires: "nv.verify() || get_node()->id() ==
  // get_node()->primary(nv->view())" Effects: If "nv->view() <= view()", it
  // does not modify this and deletes "nv".  Otherwise, it adds "nv" to this and
  // if "view()
...
private:
  ...
  // than or equal to "get_node()->num_correct_replicas()"
