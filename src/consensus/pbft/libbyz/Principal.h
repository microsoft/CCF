...
{
public:
  Principal(int i, Addr a, bool replica, const std::string& cert_);
  ...
  const std::string& get_cert() const;
  ...
  void set_certificate(const std::string& cert_);
...
inline void Principal::set_certificate(const std::string& cert_)
{
...
inline const std::string& Principal::get_cert() const
{
  return cert;
}
