...
#pragma pack(pop)
  ...
  public:
    ...
    virtual kv::Version commit_tx(
      ccf::StoreTx& tx, CBuffer root, ccf::Signatures& signatures) = 0;
  ...
  public:
    ...
    kv::Version commit_tx(
      ccf::StoreTx& tx, CBuffer root, ccf::Signatures& signatures)
    {
      while (true)
      {
        auto p = x.lock();
