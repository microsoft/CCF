...
namespace aft
{
  // Can I have this generic RPC request submission context for RPCs triggered
  // by consensus, e.g. resharing updates and reconfiguration ORCs?

  class RPCRequestContextBase
  {
  protected:
