...
namespace aft
{
  std::unique_ptr<RequestCtx> ExecutionUtilitiesImpl::create_request_ctx(
  ...
  kv::Version ExecutionUtilitiesImpl::execute_request(
  ...
  std::unique_ptr<aft::RequestMessage> ExecutionUtilitiesImpl::
  ...
  kv::Version ExecutionUtilitiesImpl::commit_replayed_request(kv::Tx& tx)
  {
