...
/**
 * @file luarpcargs.h
 * @brief Convert from RpcFrontend::HandlerArgs to a lua table, giving named
...
namespace ccf
{
  ...
  {
    /**
     * __index metamethod for HandlerArgs table.
     * stack: 1 = HandlerArgs table, 2 = desired index
     */
    ...
    /**
     * Push a HandlerArgs onto the lua stack
     *
     ...
     */
    template <>
    inline void push_raw(lua_State* l, const HandlerArgs& args)
    {
    ...
    // To get HandlerArgs as a return value from lua execution, implement this
    // template <>
