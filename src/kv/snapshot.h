...
namespace kv
{
  ...
  //   void add_map_snapshot(std::unique_ptr<kv::AbstractMap::Snapshot>
  //   snapshot)
  //   {
  ...
  //     // serialized.
  //     // Note: Snapshots are always taken at compacted state so version only
  //     is
  //     // unique enough to prevent IV reuse
  //     KvStoreSerialiser serialiser(encryptor, {0, version}, version - 1,
  //     true);
