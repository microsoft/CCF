...
int main(int argc, char** argv)
{
  ...
  ringbuffer::Const to_enclave_span(
    to_enclave_buffer.data(), to_enclave_buffer.size());

  std::vector<uint8_t> from_enclave_buffer(buffer_size);
  ringbuffer::Const from_enclave_span(
    from_enclave_buffer.data(), from_enclave_buffer.size());

  ringbuffer::Circuit circuit(to_enclave_span, from_enclave_span);
  ...
  enclave_config.to_enclave_buffer_start = to_enclave_span.buffer;
  enclave_config.to_enclave_buffer_size = to_enclave_span.size;
  enclave_config.from_enclave_buffer_start = from_enclave_span.buffer;
  enclave_config.from_enclave_buffer_size = from_enclave_span.size;
