...
namespace host
{
  ...
  static constexpr auto host_config_schema = R"!!!({
    ...
    "command": {
      ...
      "properties": {
        ...
        "sealed_ledger_secret_location": {
          "type": "string",
          "description": "Path to the sealed ledger secret file. This is used to recover the ledger secret from a previous service"
        }
      },
      "allOf": [
        {
              ...
              "recover": {
                ...
                "properties": {
                  ...
                  "previous_sealed_ledger_secret_location": {
                    "type": ["string"],
                    "description": "Path to the sealed ledger secret file, if set the unsealed ledger secret will be used instead of using recovery shares."
                  }
                },
