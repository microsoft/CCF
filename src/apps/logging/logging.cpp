...
namespace logging
{
  ...
  public:
      ...
      get_public_result_schema(nlohmann::json::parse(j_get_public_out))
    {
      ...
      auto record = [this](ccf::StoreTx& tx, nlohmann::json&& params) {
      ...
      // SNIPPET_START: get
      auto get = [this](ccf::StoreTx& tx, nlohmann::json&& params) {
      ...
      auto record_public = [this](ccf::StoreTx& tx, nlohmann::json&& params) {
      ...
      auto get_public = [this](ccf::StoreTx& tx, nlohmann::json&& params) {
        const auto validation_error =
