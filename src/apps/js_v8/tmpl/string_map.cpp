...
namespace ccf::v8_tmpl
{
  ...
  {
    return static_cast<StringMap::MapType*>(obj->GetAlignedPointerFromInternalField(0));
  }

  static void map_get(v8::Local<v8::Name> name, const v8::PropertyCallbackInfo<v8::Value>& info) 
  {
    if (name->IsSymbol())
      return;
    ...
    info.GetReturnValue().Set(
        v8_util::to_v8_str(info.GetIsolate(), value));
}
  ...
  v8::Local<v8::Object> StringMap::wrap(v8::Local<v8::Context> context, const MapType& map)
  {
    v8::Isolate* isolate = context->GetIsolate();
    v8::EscapableHandleScope handle_scope(isolate);

    v8::Local<v8::ObjectTemplate> tmpl = get_cached_object_template<StringMap>(isolate);
