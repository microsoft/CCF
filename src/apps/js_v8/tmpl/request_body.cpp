...
namespace ccf::v8_tmpl
{
  ...
  {
    return static_cast<const std::vector<uint8_t>*>(obj->GetAlignedPointerFromInternalField(0));
  }
  ...
  v8::Local<v8::ObjectTemplate> RequestBody::create_template(v8::Isolate* isolate)
  {
  ...
  v8::Local<v8::Object> RequestBody::wrap(v8::Local<v8::Context> context, const std::vector<uint8_t>& body)
  {
    v8::Isolate* isolate = context->GetIsolate();
    v8::EscapableHandleScope handle_scope(isolate);

    v8::Local<v8::ObjectTemplate> tmpl = get_cached_object_template<RequestBody>(isolate);
