...
#pragma clang diagnostic ignored "-Wc99-extensions"
      ...
      [[maybe_unused]] JSValueConst* argv)
    {
      ...
      auto body_ =
        JS_NewStringLen(ctx, (const char*)body->data(), body->size());
      return body_;
    }
      ...
      [[maybe_unused]] JSValueConst* argv)
    {
      ...
      auto node = static_cast<ccf::AbstractNodeState*>(
        JS_GetOpaque(node_, node_class_id));
      ...
      JSContext* ctx)
    {
      ...
      JS_SetPropertyStr(
        ...
        ccf,
        "strToBuf",
        JS_NewCFunction(ctx, js_str_to_buf, "strToBuf", 1));
      JS_SetPropertyStr(
        ctx,
        ccf,
        "bufToStr",
        JS_NewCFunction(ctx, js_buf_to_str, "bufToStr", 1));
      JS_SetPropertyStr(
        ctx,
        ccf,
        "jsonCompatibleToBuf",
