...
#define XX_CCF_ERROR_CODES \
  ...
  XX(INVALID_CLIENT_SIGNATURE, -32012) \
  XX(INVALID_CALLER_ID, -32013) \
  XX(CODE_ID_NOT_FOUND, -32014) \
  XX(CODE_ID_RETIRED, -32015) \
  XX(RPC_NOT_FORWARDED, -32016) \
  XX(CCF_APP_ERROR_START, -32050)
