...
#pragma clang diagnostic pop
    ...
    {
      // constexpr bool is_map = nonstd::is_specialization<T,
      // kv::TypedMap>::value; constexpr bool is_value =
      //   nonstd::is_specialization<T, kv::TypedValue>::value;

      // if constexpr (!(is_map || is_value))
      // {
      //   static_assert(nonstd::dependent_false_v<T>, "Unsupported table
      //   type");
      // }
