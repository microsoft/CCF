...
//     const auto r = frontend_process(frontend, read_next_req,
//     new_member.cert); check_error(r, HTTP_STATUS_FORBIDDEN);
...
//         frontend_process(frontend, freshen_state_digest_req,
//         new_member->cert));
...
//        )xxx");
//     const auto vote = create_signed_request(Vote{0, vote_ballot}, "vote",
//     kp);
...
//     const auto vote = create_signed_request(Vote{1, vote_ballot}, "vote",
//     kp); check_result_state(
//       frontend_process(frontend, vote, member_1_cert),
//       ProposalState::ACCEPTED);
//   }
...
//     const auto withdraw = create_signed_request(param, "withdraw",
//     caller.kp);
...
//     const auto vote = create_signed_request(Vote{0, vote_against}, "vote",
//     kp); const auto r = frontend_process(frontend, vote, voter_b_cert);
...
//     const auto vote =
//       create_signed_request(Vote{proposal_id, vote_for}, "vote", kp);
//     const auto r = frontend_process(frontend, vote,
