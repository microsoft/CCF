...
// unit tests such as the frontend_test
      ...
      auto js_metrics = [this](auto& args, nlohmann::json&&) {
        ...
        m.max_stack_size = js::Runtime::default_stack_size;
        m.max_heap_size = js::Runtime::default_heap_size;
        m.max_execution_time = js::Runtime::default_max_execution_time.count();
