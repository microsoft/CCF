...
namespace ccf
{
  ...
  public:
    ...
    virtual bool accept_recovery(ccf::Tx& tx) = 0;
    virtual bool open_network(ccf::Tx& tx) = 0;
    virtual bool rekey_ledger(ccf::Tx& tx) = 0;
    ...
    virtual bool split_ledger_secrets(ccf::Tx& tx) = 0;
    virtual bool restore_ledger_secrets(
      ccf::Tx& tx, const std::vector<SecretSharing::Share>& shares) = 0;
  };
}
