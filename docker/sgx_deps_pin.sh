...
wget -r -l1 --no-parent -nd -A "*sgx_$(echo ${PSW_VERSION//./_})_${UBUNTU}_custom_version.cfg" "https://download.01.org/intel-sgx/sgx_repo/ubuntu/apt_preference_files"
mv "*sgx_$(echo ${PSW_VERSION//./_})_${UBUNTU}_custom_version.cfg" "/etc/apt/preferences.d/intel-sgx.pref"