...
* **LEDGER_CURVE_CHOICE**: String, one of ``secp384r1``, ``curve25519``, ``secp256k1_mbedtls``, ``secp256k1_bitcoin``. Elliptic curve to use for CCF network and node identity. Defaults to ``secp384r1``.
