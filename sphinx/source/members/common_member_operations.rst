...
Once the recovery of the private ledger is complete on all the nodes that have joined the new network, the ledger is fully recovered and users are able to continue issuing business transactions.
