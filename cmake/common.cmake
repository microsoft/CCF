...
set(LEDGER_CURVE_CHOICE "secp384r1" CACHE STRING "One of secp384r1, curve25519, secp256k1_mbedtls, secp256k1_bitcoin")
if (${LEDGER_CURVE_CHOICE} STREQUAL "secp384r1")
  add_definitions(-DLEDGER_CURVE_CHOICE_SECP384R1)
elseif (${LEDGER_CURVE_CHOICE} STREQUAL "curve25519")
  add_definitions(-DLEDGER_CURVE_CHOICE_CURVE25519)
elseif (${LEDGER_CURVE_CHOICE} STREQUAL "secp256k1_mbedtls")
  add_definitions(-DLEDGER_CURVE_CHOICE_SECP256K1_MBEDTLS)
elseif (${LEDGER_CURVE_CHOICE} STREQUAL "secp256k1_bitcoin")
  add_definitions(-DLEDGER_CURVE_CHOICE_SECP256K1_BITCOIN)
else ()
  message(FATAL_ERROR "Unsupported curve choice ${LEDGER_CURVE_CHOICE}")
endif ()
