...
function(add_e2e_test)
  ...
  if(BUILD_END_TO_END_TESTS)
    ...
    set_property(
      ...
      PROPERTY ENVIRONMENT "PYTHONPATH=${CCF_DIR}/tests:${CCF_DIR}/ccftools:$ENV{PYTHONPATH}"
    )
...
function(add_perf_test)
  ...
  set_property(
    ...
    PROPERTY
      ENVIRONMENT
      "PYTHONPATH=${CCF_DIR}/tests:${CCF_DIR}/ccftools:${CMAKE_CURRENT_BINARY_DIR}:$ENV{PYTHONPATH}"
  )
  if(DEFINED DEFAULT_ENCLAVE_TYPE)
    set_property(
      TEST ${PARSED_ARGS_NAME} APPEND
