...
find_library(TLS_LIBRARY ssl "${OPENSSL_INSTALL_PATH}/lib64")
...
# target_compile_definitions(ccfcrypto.host PUBLIC
...
target_link_libraries(
  ccfcrypto.host PUBLIC "${OPENSSL_INSTALL_PATH}/lib64/libcrypto.so"
)
target_link_libraries(
  ccfcrypto.host PUBLIC "${OPENSSL_INSTALL_PATH}/lib64/libssl.so"
)
