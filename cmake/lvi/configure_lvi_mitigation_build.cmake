...
macro(detect_compiler BINDIR CC)
  ...
  # Use the second level of unwrapping on COMPILER to get the compiler name. If
  # the default compiler is not found, use the following logic to detect the
  # compiler.
...
function(configure_lvi_mitigation_build)
  ...
  # Overwrite the default C compiler if CC is explicitly specified. Otherwise,
  # select the compiler based on the detection logic.
  if(DEFINED ENV{CC})
