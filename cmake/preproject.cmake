...
if("${COMPILE_TARGET}" STREQUAL "snp")
  if(NOT "${CMAKE_BUILD_TYPE}" STREQUAL "Debug")
    check_c_compiler_flag(
      "${SPECTRE_MITIGATION_FLAGS}" SPECTRE_MITIGATION_C_FLAGS_SUPPORTED
    )
    check_cxx_compiler_flag(
      "${SPECTRE_MITIGATION_FLAGS}" SPECTRE_MITIGATION_CXX_FLAGS_SUPPORTED
    )
    if(SPECTRE_MITIGATION_C_FLAGS_SUPPORTED
      ...
      message(FATAL_ERROR "Spectre 1 mitigation NOT supported.")
    endif()
  endif()
endif()
