...
CCF has its own performance testing tool (Piccolo), split between :ccf_repo:`tests/infra/piccolo`
and :ccf_repo:`tests/perf-system/submitter`, to measure the performance of CCF and its applications. The aim of
