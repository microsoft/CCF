...
Commands can also be signed using the `python-cwt <https://github.com/dajiaji/python-cwt/>`_ library, and sent with any standard HTTP library such as `Python urllib3 <https://urllib3.readthedocs.io/>`_.
