...
- An optional set of :ref:`JavaScript FFI Plugins <build_apps/api:JavaScript FFI Plugins>` that shall be registered to extend the built-in JavaScript API surface.
