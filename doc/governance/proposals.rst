...
.. code-block:: bash
    ...
    usage: proposal_generator.py [-h] [-po PROPOSAL_OUTPUT_FILE] [-vo VOTE_OUTPUT_FILE] [-pp] [-i] [-v]
                             {accept_recovery,new_member,new_node_code,new_user,open_network,rekey_ledger,remove_user,remove_member,retire_node,set_js_app,set_recovery_threshold,set_user_data,trust_node,update_recovery_shares}
