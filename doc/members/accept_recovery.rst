...
.. code-block:: bash
    ...
    $ ./scurl.sh https://<ccf-node-address>/gov/proposal/1/vote --cacert network_cert --key member2_privk --cert member2_cert --data-binary @vote_accept.json -H "content-type: application/json"
    {
        "proposal_id": 1,
        "proposer_id": 0,
        "state": "OPEN"
    ...
    $ ./scurl.sh https://<ccf-node-address>/gov/proposal/1/vote --cacert network_cert --key member3_privk --cert member3_cert --data-binary @vote_accept.json -H "content-type: application/json"
    {
        "proposal_id": 1,
        "proposer_id": 0,
        "state": "ACCEPTED"
