...
The `Confidential Consortium Framework (CCF) <https://ccf.microsoft.com/>`_ is an open-source framework for building a new category of secure, highly-available, and performant applications that focus on multi-party compute and data.
