...
def run(args):
    ...
    with infra.ccf.network(
        ...
        manager = AppUser(network, "manager", "GB", args.participant_curve)
        regulator = AppUser(network, "auditor", "GB", args.participant_curve)
        banks = [
            AppUser(network, f"bank{country}", country, args.participant_curve)
