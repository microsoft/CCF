...
bool EverCrypt_AEAD_uu___is_Hacl_CHACHA20_POLY1305(EverCrypt_AEAD_impl projectee)
{
  switch (projectee)
  {
    case EverCrypt_AEAD_Hacl_CHACHA20_POLY1305:
      {
        return true;
      }
    default:
...
bool EverCrypt_AEAD_uu___is_Vale_AES128_GCM(EverCrypt_AEAD_impl projectee)
{
  switch (projectee)
  {
    case EverCrypt_AEAD_Vale_AES128_GCM:
      {
        return true;
      }
    default:
...
bool EverCrypt_AEAD_uu___is_Vale_AES256_GCM(EverCrypt_AEAD_impl projectee)
{
  switch (projectee)
  {
    case EverCrypt_AEAD_Vale_AES256_GCM:
      {
        return true;
      }
    default:
...
uint8_t *EverCrypt_AEAD___proj__Ek__item__ek(Spec_AEAD_alg a, EverCrypt_AEAD_state_s projectee)
{
  return projectee.ek;
}
...
Spec_AEAD_alg EverCrypt_AEAD_alg_of_state(EverCrypt_AEAD_state_s *s)
{
  ...
  EverCrypt_AEAD_impl impl = scrut.impl;
  switch (impl)
  {
    case EverCrypt_AEAD_Hacl_CHACHA20_POLY1305:
      {
        return Spec_AEAD_CHACHA20_POLY1305;
      }
    case EverCrypt_AEAD_Vale_AES128_GCM:
      {
        return Spec_AEAD_AES128_GCM;
      }
    case EverCrypt_AEAD_Vale_AES256_GCM:
      {
        return Spec_AEAD_AES256_GCM;
      }
    default:
      {
...
EverCrypt_AEAD_create_in_chacha20_poly1305(EverCrypt_AEAD_state_s **dst, uint8_t *k1)
{
  ...
  EverCrypt_AEAD_state_s *p1 = KRML_HOST_MALLOC(sizeof (EverCrypt_AEAD_state_s));
  p1[0U] = ((EverCrypt_AEAD_state_s){ .impl = EverCrypt_AEAD_Hacl_CHACHA20_POLY1305, .ek = ek });
...
EverCrypt_AEAD_create_in_aes128_gcm(EverCrypt_AEAD_state_s **dst, uint8_t *k1)
{
  ...
  if (has_aesni1 && has_pclmulqdq1 && has_avx1)
  {
    ...
    KRML_CHECK_SIZE(sizeof (EverCrypt_AEAD_state_s), (uint32_t)1U);
    EverCrypt_AEAD_state_s *p1 = KRML_HOST_MALLOC(sizeof (EverCrypt_AEAD_state_s));
    p1[0U] = ((EverCrypt_AEAD_state_s){ .impl = EverCrypt_AEAD_Vale_AES128_GCM, .ek = ek });
    *dst = p1;
    return EverCrypt_Error_Success;
  }
  #endif
...
EverCrypt_AEAD_create_in_aes256_gcm(EverCrypt_AEAD_state_s **dst, uint8_t *k1)
{
  ...
  if (has_aesni1 && has_pclmulqdq1 && has_avx1)
  {
    ...
    KRML_CHECK_SIZE(sizeof (EverCrypt_AEAD_state_s), (uint32_t)1U);
    EverCrypt_AEAD_state_s *p1 = KRML_HOST_MALLOC(sizeof (EverCrypt_AEAD_state_s));
    p1[0U] = ((EverCrypt_AEAD_state_s){ .impl = EverCrypt_AEAD_Vale_AES256_GCM, .ek = ek });
    *dst = p1;
    return EverCrypt_Error_Success;
  }
  #endif
...
)
{
  ...
  {
    EverCrypt_AEAD_state_s scrut = *s;
    EverCrypt_AEAD_impl i1 = scrut.impl;
    uint8_t *ek = scrut.ek;
    switch (i1)
    {
      case EverCrypt_AEAD_Vale_AES128_GCM:
      ...
      case EverCrypt_AEAD_Hacl_CHACHA20_POLY1305:
        {
          Hacl_Impl_Chacha20Poly1305_aead_encrypt_chacha_poly(ek,
            iv,
            ad_len,
            ad,
            plain_len,
      ...
      case EverCrypt_AEAD_Hacl_CHACHA20_POLY1305:
        {
          uint32_t
          r =
            Hacl_Impl_Chacha20Poly1305_aead_decrypt_chacha_poly(ek,
              iv,
              ad_len,
              ad,
              cipher_len,
