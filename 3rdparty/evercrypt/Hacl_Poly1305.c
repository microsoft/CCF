...
inline void Hacl_Poly1305_32_poly1305_init(uint64_t *ctx, uint8_t *key)
{
  uint64_t *acc = ctx;
...
inline static void Hacl_Poly1305_32_poly1305_update(uint64_t *ctx, uint32_t len, uint8_t *text)
{
  uint64_t *pre = ctx + (uint32_t)5U;
  uint64_t *acc = ctx;
...
void
(*Hacl_Poly1305_32_poly1305_update_padded)(uint64_t *x0, uint32_t x1, uint8_t *x2) =
