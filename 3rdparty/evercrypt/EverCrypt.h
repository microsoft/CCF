...
extern void EverCrypt_random_sample(uint32_t len1, uint8_t *out1);
...
extern bool EverCrypt_HMAC_is_supported_alg(Spec_Hash_Definitions_hash_alg uu___0_5835);
...
extern uint32_t EverCrypt_Hash_tagLen(Spec_Hash_Definitions_hash_alg a);

extern uint32_t EverCrypt_Hash_blockLen(Spec_Hash_Definitions_hash_alg a);
...
extern void
EverCrypt_Poly1305_poly1305(uint8_t *dst, uint8_t *src, uint32_t len1, uint8_t *key);
...
extern void EverCrypt_Curve25519_ecdh(uint8_t *shared, uint8_t *my_priv, uint8_t *their_pub);
