...
#define EverCrypt_Hacl_x25519 Hacl_Curve25519_crypto_scalarmult

extern void EverCrypt_Hacl_x25519(uint8_t *x0, uint8_t *x1, uint8_t *x2);

#define EverCrypt_Hacl_aes128_mk_sbox Crypto_Symmetric_AES128_mk_sbox

extern void EverCrypt_Hacl_aes128_mk_sbox(uint8_t *x0);

#define EverCrypt_Hacl_aes128_keyExpansion Crypto_Symmetric_AES128_keyExpansion

extern void EverCrypt_Hacl_aes128_keyExpansion(uint8_t *x0, uint8_t *x1, uint8_t *x2);

#define EverCrypt_Hacl_aes128_cipher Crypto_Symmetric_AES128_cipher

extern void EverCrypt_Hacl_aes128_cipher(uint8_t *x0, uint8_t *x1, uint8_t *x2, uint8_t *x3);

#define EverCrypt_Hacl_aes256_mk_sbox Crypto_Symmetric_AES_mk_sbox

extern void EverCrypt_Hacl_aes256_mk_sbox(uint8_t *x0);

#define EverCrypt_Hacl_aes256_keyExpansion Crypto_Symmetric_AES_keyExpansion

extern void EverCrypt_Hacl_aes256_keyExpansion(uint8_t *x0, uint8_t *x1, uint8_t *x2);

#define EverCrypt_Hacl_aes256_cipher Crypto_Symmetric_AES_cipher

extern void EverCrypt_Hacl_aes256_cipher(uint8_t *x0, uint8_t *x1, uint8_t *x2, uint8_t *x3);

#define EverCrypt_Hacl_chacha20(key, iv, ctr, plain, len, cipher) Hacl_Chacha20_chacha20(cipher, plain, len, key, iv, ctr)

extern void
EverCrypt_Hacl_chacha20(
  uint8_t *x0,
  uint8_t *x1,
  uint32_t x2,
  uint8_t *x3,
...
#define EverCrypt_Hacl_chacha20_poly1305_encrypt Hacl_Chacha20Poly1305_aead_encrypt

extern uint32_t
EverCrypt_Hacl_chacha20_poly1305_encrypt(
  uint8_t *x0,
  uint8_t *x1,
  uint8_t *x2,
  uint32_t x3,
...
#define EverCrypt_Hacl_chacha20_poly1305_decrypt Hacl_Chacha20Poly1305_aead_decrypt

extern uint32_t
EverCrypt_Hacl_chacha20_poly1305_decrypt(
  uint8_t *x0,
  uint8_t *x1,
  uint32_t x2,
  uint8_t *x3,
