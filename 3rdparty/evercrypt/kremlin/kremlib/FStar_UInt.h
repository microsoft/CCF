...
extern FStar_Seq_Base_seq__bool FStar_UInt_to_vec(Prims_int x0, Prims_int x1);

extern Prims_int FStar_UInt_from_vec(Prims_int x0, FStar_Seq_Base_seq__bool x1);
...
FStar_UInt_zero_extend_vec(Prims_pos x0, FStar_Seq_Base_seq__bool x1);

extern FStar_Seq_Base_seq__bool
FStar_UInt_one_extend_vec(Prims_pos x0, FStar_Seq_Base_seq__bool x1);
