...
#ifndef __EverCrypt_Misc_H
#define __EverCrypt_Misc_H


#include "kremlib.h"
#include "kremlin/internal/compat.h"

extern void aes128_key_expansion_sbox(uint8_t *x0, uint8_t *x1, uint8_t *x2);

extern void aes128_encrypt_one_block(uint8_t *x0, uint8_t *x1, uint8_t *x2, uint8_t *x3);
...
extern void __stdcall aes128_key_expansion(uint8_t *x0, uint8_t *x1);

extern void __stdcall gcm128_encrypt(gcm_args *x0);

extern uint32_t __stdcall gcm128_decrypt(gcm_args *x0);

extern void __stdcall aes256_key_expansion(uint8_t *x0, uint8_t *x1);

extern void __stdcall gcm256_encrypt(gcm_args *x0);

extern uint32_t __stdcall gcm256_decrypt(gcm_args *x0);

#define __EverCrypt_Misc_H_DEFINED
#endif
