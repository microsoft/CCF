...
Tests are run on two different testbeds for comparison: gha-vmss-d16av7-ci (Standard_D16ads_v7 VMs with 16 vCPUs and 64 GiB RAM) and gha-c-aci-ci (C-ACI with 16 cores and 32 GiB RAM).
...
upload the original node logs consumed directly by Lean.
