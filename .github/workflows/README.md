...
Tests are run and published on two different testbeds for comparison: gha-vmss-d16av6-ci (d16av5 VMs) and gha-c-aci-ci (C-ACI with 16 cores and 32Gb RAM), and are labeled accordingly in the bencher UI.
