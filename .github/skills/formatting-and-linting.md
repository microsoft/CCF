...
| `scripts/non-ascii-checks.sh`    | `scripts/non-ascii-checks.sh`    | `.h`, `.hpp`, `.c`, `.cpp`, `.py` (excludes `3rdparty/` and intentionally non-ASCII files) | Non-ASCII characters that must be replaced with their plain ASCII equivalents                                                          |

## Which scripts to run for each file type

| If you modified                                             | Run these scripts                                                                                                                |
| ----------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------- |
| C/C++ source or headers (`.h`, `.hpp`, `.c`, `.cpp`, `.cc`) | `cpp-format-checks.sh -f`, `includes-checks.sh`, `copyright-checks.sh`, `non-ascii-checks.sh`                                    |
| Python files (`.py`)                                        | `python-format-checks.sh -f`, `python-lint-checks.sh -f`, `python-types-checks.sh`, `copyright-checks.sh`, `non-ascii-checks.sh` |
